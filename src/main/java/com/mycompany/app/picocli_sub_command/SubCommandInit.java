...
public class SubCommandInit implements Callable<Integer> {
    ...
    public Integer call() throws IOException {
        ...
        public Integer call() throws IOException {
                ...
                Writer indexWriter = new BufferedWriter(new OutputStreamWriter(
                                new FileOutputStream(path.toString() + "/index.md"), StandardCharsets.UTF_8));
                ...
                Writer configWriter = new BufferedWriter(new OutputStreamWriter(
                                new FileOutputStream(path.toString() + "/config.json"), StandardCharsets.UTF_8));
                ...
                Writer menuHtml = new BufferedWriter(new OutputStreamWriter(
                                new FileOutputStream(path.toString() + "/menu.html"), StandardCharsets.UTF_8));
                ...
                Writer layoutHtml = new BufferedWriter(new OutputStreamWriter(
